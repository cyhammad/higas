...
const features = [
  {
    ...
    description:
      "Place your fuel request in seconds with our intuitive app interface.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Get multiple bids from drivers and choose the best price for you.",
    icon: (
  ...
  },
  {
    ...
    description: "Track your fuel delivery in real-time with live GPS updates.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Need fuel at midnight? We have got drivers ready anytime, anywhere.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Get instant help with our in-app chat support and ticket system.",
    icon: (
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        >
          ...
          >
            ...
            <span className="text-[#F98410]">Different</span>
          </h2>

          <p className="text-gray-500 text-[16px] md:text-lg max-w-2xl font-inter leading-relaxed">
            Experience the future of fuel delivery with our innovative platform
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              ...
              <p className="text-gray-500 text-[15px] md:text-base font-inter leading-relaxed">
                {feature.description}
              </p>
            </motion.div>
          ))}
